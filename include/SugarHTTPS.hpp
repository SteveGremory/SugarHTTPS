...
namespace sugar {
    ...
    RestClient::Response get(std::string url, std::string parameteres,  bool allowRedicts = true, int redictsCount = 3, int timeout = 5, std::string userAgent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36");
}